...
PNGFile  = sys.argv[1].replace("mlr_out", "mlr_out.png")
PSFile   = sys.argv[1].replace("mlr_out", "mlr_out.ps")
...
for line in lines:
    ...
    if line.endswith('Fit'):
       x_data.append(float(line.split()[2]))
       y_data.append(float(line.split()[3]))
