       subroutine normalization1(Experiments, Electronic, Vb, 
...
!=========================================================================
      call dnormal(Experiments(1:nSystem),nSystem,0,Exp_AV,Exp_SD)   ! normalize experimental value
         
      do i = 1, nElectronics
         call dnormal(Electronic(1:nSystem, i),nSystem,0, 
     +                Ele_AV(i),Ele_SD(i))
      enddo
      do i = 1, nPoints
         do j = 1, nSteric
            call dnormal(Vb(1:nSystem, i, j),nSystem,0, 
