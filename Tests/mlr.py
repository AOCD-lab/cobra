...
To be run as:
   python RunMLR.py -m myfile.matrix

Input:   
   MatrixFile : = myfile.matrix       Matrix describing the dataset to be learned

Output:
   OutputFile : = myfile.mlr_out      Output file with all training informations
   R2File     : = myfile.mlr_r2       Output file having inside R2 and R2-adj 
...
def GetFiles():
    ...
    OutputFile := output file name, i.e., myfile.out
